...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/19 11:51:56 by jpinyot           #+#    #+#             */
/*   Updated: 2020/02/19 11:54:56 by jpinyot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "header.h"

class LinearRegError
{
	private:
		vector<double>	x_;
		vector<double>	y_;
	...
	public:
		LinearRegError(const vector<double>& x={}, const vector<double>& y={}, const double& theta0=0, const double& theta1=0):
			x_(x), y_(y), yPred_(0), xMean_(0), yMean_(0), theta0_(theta0), theta1_(theta1), correlation_(0), MSE_(0), MAE_(0), RMSE_(0), RAE_(0), RRSE_(0)
		{};
		virtual	~LinearRegError() {};
		void	calculateError();
		string	explicidStr();
